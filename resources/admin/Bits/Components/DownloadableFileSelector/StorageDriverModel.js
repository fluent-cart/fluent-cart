...
class StorageDriverModel extends Model {
            ...
            .then((data) => {
                ...
                Object.values(this.data.drivers).forEach((driver) => {
                    if (driver.has_bucket) {
                        ...
                        this.data.needsReconfigure[driver.route] = !!driver.need_reconfigure;
                    }
                })
    ...
    needsReconfigure(driver) {
        return !!this.data.needsReconfigure[driver];
    }
    ...
    getFileList = async (driver, searchQuery = '') => {

        searchQuery = searchQuery.trim();

        if (this.hasBucket(driver) && this.needsReconfigure(driver)) {
            return [];
        }

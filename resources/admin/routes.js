...
import AdvancedInventory from './Modules/AdvancedInventory/Inventory.vue';
...
const genericDriverRoutes = (StorageDriverChildRoutes || []).filter((route) => route.name !== 's3');

for (const route of genericDriverRoutes) {
    route.props = true;
}

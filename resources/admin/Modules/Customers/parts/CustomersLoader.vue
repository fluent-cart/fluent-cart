    ...
    <el-skeleton animated>
        <template #template>
          <el-table :data="nextPageCount" class="w-full compact-table responsive">
            ...
            <el-table-column :label="$t('Customer')" width="340">
              <div class="table-cell">
                <div class="fct-product-info-card w-full">
                  <div class="fct-product-info-media">
                    <el-skeleton-item variant="image" class="w-10 h-10.5 rounded-full flex-none" />
                  </div>
            ...
            <el-table-column :label="$t('Address')" width="340">
              <div class="table-cell">
                <el-skeleton-item variant="p" class="w-4/5" />
              </div>
            </el-table-column>

            <el-table-column :label="$t('Purchases')" width="102">
              <div class="table-cell">
                <el-skeleton-item variant="p" class="w-3/5" />
              </div>
            </el-table-column>
            
            <el-table-column v-if="customerTable.isColumnVisible('ltv')" :label="$t('LTV')" width="113">
              <div class="table-cell">
                <el-skeleton-item variant="p" class="w-3/5" />
              </div>
            </el-table-column>

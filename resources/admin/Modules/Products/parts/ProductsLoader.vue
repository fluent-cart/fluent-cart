    ...
    <el-skeleton animated>
        <template #template>
          <el-table :data="nextPageCount" class="w-full compact-table responsive fct-loader-table">
              ...
              <div class="table-cell">
                <div class="fct-product-info-card w-full">
                  <div class="fct-product-info-media">
                    <el-skeleton-item variant="image" class="w-10 h-10.5 flex-none rounded-md" />
                  </div>
                  <div class="fct-product-info-details grow-0 shrink-0 basis-[calc(100%-52px)]" style="overflow: hidden;">
                    <div class="fct-product-info-name flex flex-col items-start gap-3">
                      <el-skeleton-item variant="p" class="max-w-[190px]" />
                      <el-skeleton-item variant="p" class="max-w-[100px]" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <el-table-column v-if="productTable.isColumnVisible('product_type')" :label="$t('Type')" width="170">
              <div class="table-cell">
            ...
            <el-table-column v-if="productTable.isColumnVisible('post_date')" :label="$t('Date')" width="100">
              <div class="table-cell">
                <el-skeleton-item variant="p" class="w-4/5" />
              </div>
            </el-table-column>

            <el-table-column :label="$t('Actions')" width="90" align="right">
              <div class="table-cell">

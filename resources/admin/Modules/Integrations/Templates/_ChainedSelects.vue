<template>
  <div v-loading="loading" class="fluent_cart_chained_filter">
    <el-row :gutter="0">
      <el-col :span="12" v-for="(options, optionKey) in field.fields_options" :key="optionKey"
              class="fluent_carteach_filter">
...
export default {
  ...
  methods: {
    fetchSettings() {
      this.loading = true;
      this.$get(this.field.remote_url, {

...
const chartType = ref(
  ChartTypeFilter.getChartType("subscription", "subscription_chart") || "line"
);
...
const tooltip = computed(() => {
  ...
  return translate('This report looks at the subscription you received ') + tooltipAppendix;
});
...
const toggleChartType = (type) => {
  ChartTypeFilter.onChange("subscription", "subscription_chart", type);

# Review: fluent-cart/buy-now-button

> **Reviewed:** 2026-02-26
> **Type:** Standalone (button block)
> **PHP:** `app/Hooks/Handlers/BlockEditors/Buttons/BuyNowButtonBlockEditor.php`
> **JSX:** `resources/admin/BlockEditor/Buttons/BuyNowButton/BuyNowButtonBlockEditor.jsx`
...
| B6 | `save: () => null` | PASS | |
| B8 | Category | PASS | `fluent-cart-buttons` (correct for buttons) |

...
class AddressSelectRenderer
{
    ...
    public function render()
    {
        ...
        <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
            id="<?php echo esc_attr($this->address_type); ?>_address_wrapper" role="group"
    ...
    public function renderAddressInfo()
    {
        ...
        ?>
        <label id="<?php echo esc_attr($this->address_type); ?>_address_label" class="sr-only">
            <?php echo esc_html(ucfirst($this->address_type)); ?> Address
        </label>

        <input <?php RenderHelper::renderAtts($attributes); ?> aria-labelledby="<?php echo esc_attr($this->address_type); ?>_address_label
        ...
        <div class="fct_address_info" data-fluent-cart-checkout-page-form-address-info-wrapper
            ...
            <div class="fct_checkout_address_label">
                ...
                <span><?php echo esc_html(Arr::get($this->primary_address, 'phone')); ?></span>
            </div>
            <p>
                <?php if (!empty(Arr::get($this->primary_address, 'label'))): ?>
                    <span> <?php echo esc_html(Arr::get($this->primary_address, 'label')); ?></span>
                <?php endif; ?>
                <?php echo esc_html($this->primary_address['formatted_address']['full_address']); ?>
            </p>
        </div>
        <?php
    ...
    public function renderAddressModal()
    {
        ...
        <div class="fct_address_modal_wrapper" data-fluent-cart-checkout-page-form-address-modal-wrapper="">
            ...
            <div data-fluent-cart-checkout-page-form-address-modal-body="" class="fct_address_modal hidden"
                data-fluent-cart-address-type="<?php echo esc_attr($this->address_type); ?>" role="dialog" aria-modal="true"
        ...
        <div class="fct_address_modal_footer">
            <div class="fct_address_add_btn" data-fluent-cart-checkout-page-form-address-show-add-new-modal-button
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <path d="M7 1.6665V12.3332" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round"></path>
                    <path d="M1.6665 7H12.3332" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round"></path>
                </svg>
            ...
            <button class="fct_address_apply_btn" type="button"
                ...
                aria-label="<?php echo esc_attr__('Apply selected address', 'fluent-cart'); ?>">
            ...
            <?php if (!empty($this->addresses)):
                foreach ($this->addresses as $address): ?>
                    <div class="fct_address_selector" data-id="<?php echo esc_attr($address['id']); ?>"
                        ...
                        data-state="<?php echo esc_attr($address['state']); ?>" role="button" tabindex="0" aria-pressed="false">

                        <svg class="fct_address_selector_icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                            viewBox="0 0 28 28" fill="none">
                            <path d="M0 6C0 2.68629 2.68629 0 6 0H28L14 14L0 28V6Z" fill="currentColor"></path>
                            <path d="M5.2915 9.4165L6.89567 11.0207L11.7082 5.979" stroke="white" stroke-width="1.5"
                        ...
                        <p class="fct_address_selector_info">
                            <?php if (!empty(Arr::get($address, 'label'))): ?>
                                <span> <?php echo esc_html(Arr::get($address, 'label')); ?></span>
                            <?php endif; ?>
    ...
    {
        ?>
        <div class="fct_add_new_address_form" data-fluent-cart-checkout-page-form-address-show-add-new-modal-form-wrapper="">
            <div id="<?php echo esc_attr($this->address_type); ?>_address_section_section"
                data-fluent-cart-checkout-page-form-section="" class="fct_checkout_form_section additional-address-field">
                ...
                <div class="fct_form_section_body">
                    <div class="fct_checkout_input_group">
                        <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
                            ...
                            <input type="text" name="<?php echo esc_attr($this->address_type); ?>_label" autocomplete="label"
                                placeholder="<?php echo esc_html__('e.g Home, Office', 'fluent-cart'); ?>" data-required="yes"
                                data-type="input" id="<?php echo esc_attr($this->address_type); ?>_label" maxlength="15"
                        ...
                        <?php if (!empty(Arr::get($this->requirements_fields, 'phone'))): ?>
                            <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
                                ...
                                <input type="text" name="<?php echo esc_attr($this->address_type); ?>_phone"
                                    placeholder="<?php echo esc_html__('Phone number', 'fluent-cart'); ?>" data-required="no"
                                    data-type="input" id="<?php echo esc_attr($this->address_type); ?>_phone">
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if (!empty(Arr::get($this->requirements_fields, 'country'))): ?>
                            <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
                                ...
                                <select type="text" name="<?php echo esc_attr($this->address_type); ?>_country"
                                    ...
                                    data-type="input" id="<?php echo esc_attr($this->address_type); ?>_country"
                                    class="hidden-select">
                                    <option value="">
                        ...
                        <?php if (!empty(Arr::get($this->requirements_fields, 'address_1'))): ?>
                            <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
                                ...
                                <input type="text" name="<?php echo esc_attr($this->address_type); ?>_address_1"
                                    autocomplete="address-line1" placeholder="<?php echo esc_attr($placeholder_text); ?>"
                                    data-required="yes" data-type="input" aria-required="true"
                        ...
                        <?php if (!empty(Arr::get($this->requirements_fields, 'address_2'))): ?>
                            <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
                                ...
                                <input type="text" name="<?php echo esc_attr($this->address_type); ?>_address_2"
                                    autocomplete="address-line2"
                                    placeholder="<?php echo esc_html__('Apt, suite, unit', 'fluent-cart'); ?>" data-required="no"
                                    data-type="input" id="<?php echo esc_attr($this->address_type); ?>_address_2">
                            </div>
                        <?php endif; ?>

                        <?php if (!empty(Arr::get($this->requirements_fields, 'state'))): ?>
                            <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
                                id="<?php echo esc_attr($this->address_type); ?>_state_wrapper" style="display: block;">
                                ...
                                <select type="select" name="<?php echo esc_attr($this->address_type); ?>_state"
                                    autocomplete="address-level1" data-required="yes" data-type="input"
                                    id="<?php echo esc_attr($this->address_type); ?>_state" checked="no" class="hidden-select">
                                ...
                                <div class="fct_checkout_input_group">
                                    <?php if (!empty(Arr::get($this->requirements_fields, 'city'))): ?>
                                        <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
                                            ...
                                            <input type="text" name="<?php echo esc_attr($this->address_type); ?>_city"
                                                autocomplete="address-level2"
                                                placeholder="<?php echo esc_html__('City / Town', 'fluent-cart'); ?>"
                                                data-required="yes" data-type="input"
                                                id="<?php echo esc_attr($this->address_type); ?>_city" aria-required="true">
                                        </div>
                                    <?php endif; ?>
                                    <?php if (!empty(Arr::get($this->requirements_fields, 'postcode'))): ?>
                                        <div data-fluent-cart-checkout-page-form-input-wrapper="" class="fct_input_wrapper "
                                            ...
                                            <input type="text" name="<?php echo esc_attr($this->address_type); ?>_postcode"
                                                autocomplete="postal-code"
                                                placeholder="<?php echo esc_attr__('Postcode / ZIP', 'fluent-cart'); ?>"
                                                data-required="yes" data-type="input"
                                                id="<?php echo esc_attr($this->address_type); ?>_postcode" aria-required="true">
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                ...
                <div class="fct_form_error fct_error_<?php echo esc_attr($this->address_type . '_address_section_section'); ?>"></div>
            </div>
            <div class="fct_add_new_address_form_footer">

                <button class="fct_address_cancel_btn" type="button"
                ...
                <button class="fct_address_submit_btn" type="submit"
